    ...
    const slides = [
        ...
        <SwiperSlide key={2}>
            ...
            >
                ...
                <Typography>
                    Chief naturalist at Jungle Lodges Resorts
                </Typography>
            </div>
        </SwiperSlide>,
        <SwiperSlide key={3}>
            ...
            >
                ...
                <Typography>
                    Assistant Director at Dakshin Foundation
                </Typography>
            </div>
        </SwiperSlide>,
        <SwiperSlide key={4}>
        ...
        <SwiperSlide key={5}>
            ...
            >
                ...
                <Typography>
                    Professor(retd.) at centre for Sutainable Technologies,
                    IISc, Banglore
                </Typography>
            </div>
        </SwiperSlide>,
        ...
        <SwiperSlide key={9}>
            ...
            >
                ...
                <Typography>
                    Director - Climate Policy and Clean Energy Finance Program
                    in Shakti Sustainable Energy Foundation
                </Typography>
            </div>
        </SwiperSlide>,
        <SwiperSlide key={10}>
            ...
            >
                ...
                <Typography>
                    Technical Specialist - Technical Development, Green Business
